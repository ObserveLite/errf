...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>HPC - Request</li>
</ol>
<form method="POST">
...
<div style="overflow-x:auto;">
  <table>
   ...
   ?>
      ...
      <th class="col-md-1" style="text-align: right;"><a href="approve.php?id=<?php echo $row['empId'];?>" title="Accept"><i class="fa fa-check " aria-hidden="true"></i></a>&nbsp;&nbsp;<a href="reject.php?msg=<?php echo $row['empId'];?>" title="Denied"><i class="fa fa-times" style="color: Red;" aria-hidden="true"></i></a>
