...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2023 at 06:37 AM
...
INSERT INTO `employee` (`EmpId`, `EmployeeId`, `FirstName`, `MiddleName`, `LastName`, `Birthdate`, `Gender`, `Address1`, `Address2`, `Address3`, `CityId`, `Mobile`, `Email`, `Password`, `AadharNumber`, `MaritalStatus`, `PositionId`, `CreatedBy`, `CreatedDate`, `ModifiedBy`, `ModifiedDate`, `JoinDate`, `LeaveDate`, `LastLogin`, `LastLogout`, `StatusId`, `RoleId`, `ImageName`, `MacAddress`, `nature_of_project`, `outline_of_project`, `appl`, `no_of_cpu`, `memory_req`, `os`, `os_version`) VALUES
(1, '1', 'admin', 'admin', 'admin', '1994-10-09', 1, 'address1', 'address2', 'address3', 1, 9999999999, 'admin@gmail.com', 'admin#123', '12354658496', 2, 1, 1, '2017-01-01 00:00:00', 1, '2017-01-31 10:33:33', '2017-01-11', '2017-01-18', '2022-10-10 09:10:42', '2017-02-09 15:12:09', 1, 1, 'images (2).jpg', '', '0', '0', '0', 0, '', '', ''),
(2, '6231415', 'Mark', 'D', 'Cooper', '2022-10-10', 1, 'Sample Address 101', 'Sample Address 102', '', 22, 912345678, 'mcooper@mail.com', 'mcooper#123', '', 1, 2, 1, '2022-10-10 08:01:43', 1, '2022-10-10 08:05:39', '2022-10-10', '0000-00-00', '2023-09-19 12:06:07', '2022-10-10 08:55:05', 1, 3, '33615user.png', '', '0', '0', '0', 0, '', '', '');
...
INSERT INTO `form` (`empId`, `nature_of_project`, `brief`, `appl`, `no_cpu`, `memory_req`, `os`, `os_version`) VALUES
(1, 'ARISH KUMAR', 'joisshiochqohc', 'PHOTOSHOP', 2, '2TB', 'WINDOWS', '11');
...
--
ALTER TABLE `dailyworkload`
  MODIFY `DailyWorkLoadId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
