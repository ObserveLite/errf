   ...
   <body class="size-1140">
      ...
      <header>
         <nav>
            <div class="line">
               <div class="s-10 l-9">
                  <h3 style="color: white;">High Performance Computing - Researcher Side</h3>
               </div>
                     ...
                     <ul>
                      ...
                      <!--  <li><a href="profile.php" title="Profile">Profile</a></li> -->
                        <li>
                              ...
                              <li><a href="applyleave.php">HPC - Request Form</a></li>
                              <li><a href="leavestatus.php">HPC - Request Status</a></li>
