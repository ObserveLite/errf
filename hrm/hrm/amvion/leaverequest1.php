...
<?php
  ...
  $lrequest = mysqli_query($db,"SELECT * from form WHERE leave_status='Accept' and leave_status1='Pending'");
  $laccept = mysqli_query($db,"SELECT * from form WHERE leave_status='Accept' and leave_status1='Accept'");
  $ldenied = mysqli_query($db,"SELECT * from form WHERE leave_status='Accept' and leave_status1='Reject'");
