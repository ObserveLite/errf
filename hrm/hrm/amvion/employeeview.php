...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>Researcher<i class="fa fa-angle-right"></i>Researcher View</li>
</ol>
 	...
 	<div>
		...
		<thead>
			<tr>
				...
				<th style="text-transform: capitalize; text-align: center;">Researcher Id</th>
