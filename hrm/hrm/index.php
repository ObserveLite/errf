...
<body>
	<div class="main-wthree">
		<div class="container">
			<h1 class="text-center text-white">HPC Approval System</h1>
		<div class="sin-w3-agile">
			<h2>Supervisor - Login In</h2>
			<form action="controller/login.php" method="post">
				...
				<div class="g-recaptcha" data-sitekey="6LedBq4oAAAAAAlK_iX8euTEO3U4TAF3S9gJx4M-"></div>
				...
				<div class="clearfix"></div>
				<h5 class="text-center"><a href="./dean" class="text-white" >Login as Dean</a></h5>
				<div class="clearfix"></div>
				<div class="clearfix"></div>
				<h5 class="text-center"><a href="./user" class="text-white" >Login as Researcher</a></h5>
				<div class="clearfix"></div>
				<h5 class="text-center"><a href="./amvion" class="text-white" >Amvion Login</a></h5>
				<div class="clearfix"></div>
			</form>
					<!-- <div class="back">
